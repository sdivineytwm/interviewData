...
namespace exercise.Models
{
    public partial class ContosoRetailDWContext : DbContext
    {
        ...
        public virtual DbSet<DimChannel> DimChannels { get; set; } = null!;
        ...
        public virtual DbSet<DimEntity> DimEntities { get; set; } = null!;
        public virtual DbSet<DimGeography> DimGeographies { get; set; } = null!;
        public virtual DbSet<DimMachine> DimMachines { get; set; } = null!;
        public virtual DbSet<DimOutage> DimOutages { get; set; } = null!;
        ...
        public virtual DbSet<DimStore> DimStores { get; set; } = null!;
        public virtual DbSet<FactExchangeRate> FactExchangeRates { get; set; } = null!;
        public virtual DbSet<FactInventory> FactInventories { get; set; } = null!;
        public virtual DbSet<FactItmachine> FactItmachines { get; set; } = null!;
        public virtual DbSet<FactItsla> FactItslas { get; set; } = null!;
        public virtual DbSet<FactOnlineSale> FactOnlineSales { get; set; } = null!;
        public virtual DbSet<FactSale> FactSales { get; set; } = null!;
        public virtual DbSet<FactSalesQuotum> FactSalesQuota { get; set; } = null!;
        public virtual DbSet<FactStrategyPlan> FactStrategyPlans { get; set; } = null!;
        public virtual DbSet<VCustomer> VCustomers { get; set; } = null!;
        public virtual DbSet<VCustomerOrder> VCustomerOrders { get; set; } = null!;
        public virtual DbSet<VCustomerPromotion> VCustomerPromotions { get; set; } = null!;
        public virtual DbSet<VOnlineSalesOrder> VOnlineSalesOrders { get; set; } = null!;
        public virtual DbSet<VOnlineSalesOrderDetail> VOnlineSalesOrderDetails { get; set; } = null!;
        public virtual DbSet<VProductForecast> VProductForecasts { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=Vm-test;Database=ContosoRetailDW;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DimCurrency>(entity =>
            {
                ...
                entity.HasIndex(e => e.CurrencyLabel, "AK_DimCurrency_CurrencyLabel")
                    .IsUnique();
            ...
            modelBuilder.Entity<DimCustomer>(entity =>
            {
                ...
                entity.HasIndex(e => e.CustomerLabel, "IX_DimCustomer_CustomerLabel")
                    .IsUnique();
            ...
            modelBuilder.Entity<DimProductCategory>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductCategoryLabel, "AK_DimProductCategory_ProductCategoryLabel")
                    .IsUnique();
            ...
            modelBuilder.Entity<DimPromotion>(entity =>
            {
                ...
                entity.HasIndex(e => e.PromotionLabel, "AK_DimPromotion_PromotionLabel")
                    .IsUnique();
            ...
            modelBuilder.Entity<DimSalesTerritory>(entity =>
            {
                ...
                entity.HasIndex(e => e.SalesTerritoryLabel, "AK_DimSalesTerritory_SalesTerritoryLabel")
                    .IsUnique();
                ...
                entity.HasOne(d => d.GeographyKeyNavigation)
                    .WithMany(p => p.DimSalesTerritories)
                    .HasForeignKey(d => d.GeographyKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<FactExchangeRate>(entity =>
            {
                ...
                entity.HasOne(d => d.CurrencyKeyNavigation)
                    .WithMany(p => p.FactExchangeRates)
            ...
            modelBuilder.Entity<FactStrategyPlan>(entity =>
            {
                ...
                entity.HasOne(d => d.AccountKeyNavigation)
                    .WithMany(p => p.FactStrategyPlans)
